...
ActiveRecord::Schema.define(version: 20151109043430) do
  ...
  add_index "books", ["cached_weighted_average"], name: "index_books_on_cached_weighted_average"
  add_index "books", ["cached_weighted_score"], name: "index_books_on_cached_weighted_score"
  add_index "books", ["cached_weighted_total"], name: "index_books_on_cached_weighted_total"
